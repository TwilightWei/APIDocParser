	...
	public HashMap<String, String> parse(String source, String deprecatedUrl) {
		...
		for(Element table:tables) {
			...
			for(Element href:hrefs) {
				if(apiType.contains("Interfaces") || apiType.contains("Classes") || apiType.contains("Exceptions") || apiType.contains("Annotation") || apiType.contains("Enum")) {
					depClassUrls.put(href.ownText(), source);
				}
			}
		}
		return depClassUrls;
